package mrzeeshandigital.outdoor.mrzeeshantrail.ui.composable.approot
...
import mrzeeshandigital.outdoor.mrzeeshantrail.ui.composable.navigation.AppNavHost
import mrzeeshandigital.outdoor.mrzeeshantrail.ui.composable.navigation.NavRoute
...
private val navigationItems: List<BottomNavItem> = listOf(
    BottomNavItem(
        titleRes = R.string.wqlno_bottom_bar_nav_item_home_title,
        icon = Icons.Default.Home,
        route = NavRoute.Home,
    ),
    BottomNavItem(
        titleRes = R.string.wqlno_bottom_bar_nav_item_cart_title,
        icon = Icons.Default.ShoppingCart,
        route = NavRoute.Cart,
    ),
    BottomNavItem(
        titleRes = R.string.wqlno_bottom_bar_nav_item_orders_title,
        icon = Icons.Default.CalendarToday,
        route = NavRoute.Orders,
    ),
    BottomNavItem(
        titleRes = R.string.wqlno_bottom_bar_nav_item_settings_title,
