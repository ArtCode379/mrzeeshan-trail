...
val HeadingFamily = FontFamily(Font(GoogleFont("Exo 2"), provider, weight = FontWeight.Bold))
val BodyFamily = FontFamily(Font(GoogleFont("Rajdhani"), provider, weight = FontWeight.Normal))
