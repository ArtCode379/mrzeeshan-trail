package mrzeeshandigital.outdoor.mrzeeshantrail

import android.app.Application
//[ANY][import_PrepRepository]
import mrzeeshandigital.outdoor.mrzeeshantrail.di.dataModule
import mrzeeshandigital.outdoor.mrzeeshantrail.di.dispatcherModule
import mrzeeshandigital.outdoor.mrzeeshantrail.di.viewModule
...
class WQLNOApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@WQLNOApplication)
            modules(appModules)
        }
